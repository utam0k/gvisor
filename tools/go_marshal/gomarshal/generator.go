...
import (
	...
	"github.com/utam0k/gvisor/tools/constraintutil"
)
...
func NewGenerator(srcs []string, out, outTest, outTestUnconditional, pkg string, imports []string) (*Generator, error) {
	...
	g.imports.add("github.com/utam0k/gvisor/pkg/gohacks")
	g.imports.add("github.com/utam0k/gvisor/pkg/hostarch")
	g.imports.add("github.com/utam0k/gvisor/pkg/marshal")
	return &g, nil
}
